...
fn (display Display) count_pixels() int {
	return arrays.fold[u8, int](arrays.flatten(display.pixels), 0, 
		fn (acc int, val u8) int { return acc + val }
	)
}